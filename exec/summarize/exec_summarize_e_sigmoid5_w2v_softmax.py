    ...
    for w in _window:
        for i in range(1, 6):
            ...
            for j in range(1, 51):
                ...
                output_file = experiment_dir + "summarized_out/softmax/cross_validation" + str(i) + "/epoch" + str(j) + ".tsv"
                summarize([input_file], output_file)


if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='summarize ffnn-out to english five classification with softmax')
