...
def main(start_k, end_k, start_epoch, end_epoch, n_in, n_mid, batchsize, gpu, window_size, patience=0):
    ...
    """
    print("-------------------------------------")
    print("exec_file: ja_amazon_nwjc2gnews2vec_sigmoid5_majority.py")
    ...
    # 実験ディレクトリ
    experiment_dir = constants.AMAZON_DIR + "experiment/ja/nwjc2gnews2vec_sigmoid5_majority/window" + str(window_size) + "/"
