...
def main(input_files, output_file):
    ...
    # 実行
    j_svm_w2v.summarize_svm_w2v(input_files, output_file)


if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='summarize svm-out to japanese binary classification with majority')
