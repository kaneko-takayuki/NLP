...
def main(x, input_files, labels, xlabel, ylabel, title):
    # プロジェクトディレクトリを取得
    ...
    # グラフを描画
    drawer.draw_graph(left, input_files, labels, xlabel, ylabel, title)
...
if __name__ == '__main__':
    ...
    main(args.x, args.files, args.labels, args.xlabel, args.ylabel, args.title)
